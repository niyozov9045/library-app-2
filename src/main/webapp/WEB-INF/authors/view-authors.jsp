...
<a href="/authors/get-form">+ new author</a>


<c:forEach items="${mualliflar}" var="muallif" varStatus="loop">
    <tr>
        <td>${muallif.fullName}</td>
        <td>${muallif.biography}</td>
        <td><a href="/authors/edit/${muallif.id}">Edit</a></td>
        <td><a href="/authors/delete/${muallif.id}">Delete</a></td>
    </tr>
